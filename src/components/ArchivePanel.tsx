...
import { Archive, RefreshCw, Trash2, Search, Filter, Folder, Calendar, User as UserIcon, Clock, ExternalLink, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-3xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {/* SUB TABS */}
        <div className="flex items-center bg-slate-100 p-1 rounded-lg self-start sm:self-center">
          <button
            onClick={() => {
              ...
              return (
                ...
                >
                  <div>
                    ...
                    {/* Task Code & Title */}
                    <h3 className="text-xs font-bold text-slate-900 group-hover:text-indigo-600 transition-colors flex items-start gap-1.5">
                    ...
                    {/* Task Description */}
                    {task.description && (
                      <p className="text-[11px] text-slate-500 line-clamp-2 mt-1 mb-3 bg-slate-50/50 p-1.5 rounded border border-slate-100">
                        {task.description}
                      </p>
                    )}
            ...
            {archivedProjects.map(proj => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 mb-4 select-none">
